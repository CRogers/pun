...
(function() {
  ...
  addExports({
    ADT: function(ctors) {
      ...
      retStruct = {};
      _fn = function() {
        var Ctorf, i, newlessConstructorObj, params, _fn1, _i, _ref;
        params = ctors[ctor];
...
(function() {
  ...
  addExports({
    ...
    uncurry: function() {
      ...
      return function() {
        var argPos, args, argsLeft, i, res, struct, _i, _ref;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
...
(function() {
  ...
  matchPattern = function(bindings, args, value, pattern) {
    var i, key, valuePattern, vtype, _i, _j, _ref, _ref1;
    if (pattern === pun._) {
      return true;
    }
    ...
    if (pattern.__ADTIdent === ADTIdent) {
      ...
      for (i = _i = 0, _ref = pattern.__ADTArgs; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    switch (typeof pattern) {
      ...
      case 'object':
        if (Array.isArray(pattern)) {
          ...
          for (i = _j = 0, _ref1 = pattern.length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
  ...
  addExports({
    ...
    match: function() {
      ...
      return function(value) {
        var bindings, i, matchArgs, matchFunc, pattern, _i, _ref;
...
// Generated by CoffeeScript 1.6.3
(function() {
  var $, BTree, Either, List, Maybe, Tree, Tuple, add, all, andL, any, append, booland, boolnot, boolor, compose, concat, constant, cube, div, either, equals, filter, flip, foldBT, foldT, foldl, foldl1, foldr, foldr1, head, id, init, last, map, mul, orL, square, stdfuncs, stdtypes, sub, tail, toArray, toList, unfold, unfoldL, untilP, _;
  ...
  List = stdtypes.List, BTree = stdtypes.BTree, Tree = stdtypes.Tree, Maybe = stdtypes.Maybe, Either = stdtypes.Either, Tuple = stdtypes.Tuple;
